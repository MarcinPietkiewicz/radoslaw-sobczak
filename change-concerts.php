...
<head>
  ...
  <title>Edycja program koncertów</title>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>
<body>
  <div class="menu edit">
    <div id="edit-title">Edycja programu koncertów</div>
    <?php include 'protected/functions.php' ?>
    <?php include 'protected/password.php' ?>
    <div id="version">Wersja - <?php read_file_name('concerts'); ?></div>
    ...
    <form id="edit-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
      <textarea id="change-area" id="concerts" name="concerts" rows="12" cols="60"><?php
      read_file('concerts');
      ?></textarea>
